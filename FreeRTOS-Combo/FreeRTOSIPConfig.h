...
#define ipconfigEVENT_QUEUE_LENGTH \
    ( ipconfigNUM_NETWORK_BUFFER_DESCRIPTORS + 10 )

#define ipconfigUDP_MAX_RX_PACKETS				20
...
#define ipconfigTCP_TX_BUFFER_LENGTH  		( 128 * ipconfigTCP_MSS )
#define ipconfigTCP_RX_BUFFER_LENGTH  		( 128 * ipconfigTCP_MSS )
...
#define ipconfigTLS_TX_BUFSIZE				( 256 * 1024 )
#define ipconfigTLS_TX_WINSIZE				( 8 )
#define ipconfigTLS_RX_BUFSIZE				(( 256 * 1024 )-1)
#define ipconfigTLS_RX_WINSIZE				( 12 )
...
#define ipconfigTCP_WIN_SEG_COUNT                      1024
...
#define ipconfigTCP_KEEP_ALIVE_INTERVAL          ( 20 ) /* Seconds. */
 ...
 #define ipconfigNIC_N_TX_DESC				( 128 )
 #define ipconfigNIC_N_RX_DESC				( 128 )
