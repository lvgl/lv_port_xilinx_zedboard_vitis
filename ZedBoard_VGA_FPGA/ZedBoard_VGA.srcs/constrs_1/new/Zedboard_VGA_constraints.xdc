...
set_clock_groups -name 100Mhz -asynchronous -group [get_clocks clk_fpga_0]
set_clock_groups -name 200Mhz -asynchronous -group [get_clocks clk_fpga_1]

create_generated_clock -name {design_1_i/Zedboard_AXI_VGA_0/inst/px_nco/px_nco_phase[0]} -source [get_pins {design_1_i/processing_system7_0/inst/PS7_i/FCLKCLK[1]}] -divide_by 1 [get_pins {design_1_i/Zedboard_AXI_VGA_0/inst/px_nco/phase_out_reg[35]/Q}]
create_generated_clock -name {design_1_i/c_counter_binary_0/U0/i_synth/i_baseblox.i_baseblox_counter/the_addsub/no_pipelining.the_addsub/i_lut6.i_lut6_addsub/i_q.i_simple.qreg/Q[20]} -source [get_pins {design_1_i/processing_system7_0/inst/PS7_i/FCLKCLK[0]}] -divide_by 4194304 [get_pins {design_1_i/c_counter_binary_0/U0/i_synth/i_baseblox.i_baseblox_counter/the_addsub/no_pipelining.the_addsub/i_lut6.i_lut6_addsub/i_q.i_simple.qreg/i_no_async_controls.output_reg[22]/Q}]
